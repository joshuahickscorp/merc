...
#
#   bash ops/scripts/cloudflare-teardown.sh plan      # show everything, delete nothing
#   bash ops/scripts/cloudflare-teardown.sh apply     # delete, with per-item confirmation
#   bash ops/scripts/cloudflare-teardown.sh apply --yes   # no prompts (scripted use)
#
