...
#
#   bash ops/scripts/merc-cloudflare-key.sh
#
...
[ -f "$ENV_FILE" ] || die "$ENV_FILE not found; run ops/scripts/merc-secrets.sh first"
...
say ""
say "next:"
say "  bash ops/scripts/cloudflare-teardown.sh plan"
