...
# harness ops/scripts/test-alert-delivery.sh (that script's default output is
...
bash "$ROOT/ops/scripts/test-alert-delivery.sh"
...
stamp(doc, candidate_commit(str(root)), "ops/scripts/produce-alert-delivery-r1.sh")
