...
# src/control/api.go:151-152 and were serving traffic while absent from this matrix.
...
# authAdmin at src/control/api.go:218,220. Neither can promote a cell by itself --
