...
# The existing ops/scripts/test-alert-delivery.sh proves a local sink only.
...
usage() {
  cat >&2 <<'USAGE'
usage: ops/scripts/alpha/alert-sink.sh --print-runbook|--check|--execute|--record-pass
...
ops/scripts/alpha/alert-sink.sh --execute
#
