...
fsck as a supplementary cross-check and report both.
    ...
    python3 ops/scripts/verify-lfs-corpus.py
    python3 ops/scripts/verify-lfs-corpus.py --root DIR
    python3 ops/scripts/verify-lfs-corpus.py --json
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument(
        ...
        type=Path,
        default=None,
        help="repository root (default: parent of ops/scripts/)",
    )
    ap.add_argument(
        "--ledger",
        type=Path,
