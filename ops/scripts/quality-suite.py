...
quantization and not sampling noise.
    ...
    python3 ops/scripts/quality-suite.py --out evidence/bench/quality-suite.jsonl
"""
...
def main() -> int:
    ...
    try:
        write_bound_jsonl_sidecar(
            out,
            harness="ops/scripts/quality-suite.py",
            repo_root=ROOT,
            ...
            corpus_na="prompt set is embedded in ops/scripts/quality-suite.py",
        )
