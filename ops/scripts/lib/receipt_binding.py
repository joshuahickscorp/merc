...
their own provenance shape, or none. `ops/scripts/validate-readiness.py` then scored
...
def candidate_commit(root: str = ".") -> str:
    ...
    This is only honest because ops/scripts/validate-readiness.py separately asserts
...
def _selftest() -> None:
    ...
    doc = stamp({"kind": "x"}, real, "ops/scripts/thing.py")
