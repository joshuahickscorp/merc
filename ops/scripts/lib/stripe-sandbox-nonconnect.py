    ...
    if os.environ.get("MERC_STRIPE_FULL_MATRIX") == "1":
        ...
        if gate:
            ...
            remaining_detail = (
                ...
                "run ops/scripts/stripe-sandbox.sh matrix to finish transfer/payouts"
            )
            matrix.add(
                "connected_account_creation",
                BLOCKED,
...
def build_receipt(
    ...
    return {
        ...
        "harness": {
            ...
            "nonconnect_driver": "ops/scripts/stripe-sandbox-nonconnect.sh",
            "connect_remainder_command": "ops/scripts/stripe-sandbox-connect.sh",
        ...
        "notes": matrix.notes,
        "validator": {
            "path": "ops/scripts/validate-readiness.py:stripe_sandbox_matrix_proven",
