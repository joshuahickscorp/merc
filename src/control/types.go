...
//
// Each class must also appear in sustainedWattsByHWClass with MEASURED,
// ASSUMED, or VENDOR_WALL_UPPER_BOUND provenance, or supplier viability
...
type TaskCommit struct {
	...
	// task's completions (src/agent/src/inference.rs). Until it did, this field was
