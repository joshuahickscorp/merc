...
func localClusterConstructionRefusal() TopologyConstructionRefusal {
	return TopologyConstructionRefusal{
		...
		Enforced: "src/control/fabric_topology.go:LocalClusterAdmissible=false; " +
			"src/control/fabric_topology_planner.go:fabricTopologyAdmittedStatus never emitted",
	}
}
...
func wanTightConstructionRefusal(degree int, fabric FabricClass) TopologyConstructionRefusal {
	return TopologyConstructionRefusal{
		...
		Reason: fmt.Sprintf(
			...
			degree, fabric),
		Enforced: "src/control/execution_mode.go:ChooseExecutionMode WAN/unmeasured tight refusal; " +
			"src/control/topology_planner.go:PlanTopology",
	}
}
	...
	out := TopologyDecision{
		...
		ConstructionRefusals: []TopologyConstructionRefusal{
			localClusterConstructionRefusal(),
			{
				...
				Enforced: "src/control/exact_reuse_batch.go: complete job without scheduler claim",
			},
		},
	...
	out := TopologyDecision{
		...
		ConstructionRefusals: []TopologyConstructionRefusal{
			localClusterConstructionRefusal(),
			{
				...
				Enforced: "src/control/service_leases.go:CreateServiceLease freezes pricing, not topology",
			},
		},
		Evidence: []string{
