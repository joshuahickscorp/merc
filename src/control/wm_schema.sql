...
-- plane's runtime Migrate() (which applies src/control/schema.sql as the authority
...
--
-- The hard invariant, proven at the database by src/control/wm_boundary_test.go:
