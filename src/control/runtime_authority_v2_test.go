...
// routability backed by src/control/runtime-profiles/vllm-llama-3.2-1b-instruct-bf16.json
...
// ops/scripts/gen-benchmark-manifest.py, which does not exist in this tree. A check
