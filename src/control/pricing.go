...
var sustainedWattsByHWClass = map[string]governedSustainedWatts{
	"apple_silicon_base": wattsAssumed(20.0,
		"ASSUMED by src/control/pricing.go: whole-package sustained draw for apple_silicon_base under inference-shaped load; no bound host power receipt"),
	"apple_silicon_pro": wattsAssumed(30.0,
		"ASSUMED by src/control/pricing.go: whole-package sustained draw for apple_silicon_pro under inference-shaped load; no bound host power receipt"),
	"apple_silicon_max": wattsAssumed(45.0,
		"ASSUMED by src/control/pricing.go: whole-package sustained draw for apple_silicon_max under inference-shaped load; no bound host power receipt"),
	...
	"nvidia_24gb": wattsAssumed(350.0,
		"ASSUMED by src/control/pricing.go: ~350 W board-power class for 24GB CUDA cards under inference; no NVIDIA device on this host to measure"),
	"nvidia_48gb": wattsAssumed(300.0,
		"ASSUMED by src/control/pricing.go: ~300 W board-power class for 48GB CUDA cards under inference; no NVIDIA device on this host to measure"),
	"nvidia_80gb": wattsAssumed(400.0,
		"ASSUMED by src/control/pricing.go: ~400 W board-power class for 80GB CUDA cards under inference; no NVIDIA device on this host to measure"),
	"nvidia_180gb": wattsAssumed(1000.0,
		"ASSUMED by src/control/pricing.go: ~1000 W board-power class for 180GB multi-GPU / H-class nodes under inference; no NVIDIA device on this host to measure"),
	"cpu": wattsAssumed(25.0,
		"ASSUMED by src/control/pricing.go: ~25 W sustained for a CPU-only worker class; not an admitted registration class and not measured"),
}
