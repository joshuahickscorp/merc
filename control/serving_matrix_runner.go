...
//
// Speaks the same chat/completions shape as scripts/runtime-parity-sweep.py and
// scripts/gateway-parity.py so a receipt from this harness is comparable to
