...
rg --fixed-strings 'source "$ROOT/scripts/lib/mutation-load-preflight.sh"' \
  scripts/mutation-test-parallel.sh >/dev/null
...
rg --fixed-strings 'mutation_derive_suite_timeout_seconds' scripts/mutation-test-parallel.sh >/dev/null
rg --fixed-strings 'load_precondition_waived' scripts/mutation-test-parallel.sh >/dev/null
rg --fixed-strings 'measured_baseline_seconds' scripts/mutation-test-parallel.sh >/dev/null
rg --fixed-strings 'derived_suite_timeout_seconds' scripts/mutation-test-parallel.sh >/dev/null
...
rg --fixed-strings 'MERC_MUTATION_SUITE_TIMEOUT' scripts/mutation-test.sh >/dev/null
rg --fixed-strings 'MERC_MUTATION_SUITE_TIMEOUT_FLAG' scripts/mutation-test.sh >/dev/null

if rg -n -F -- '-timeout=2m' scripts/mutation-test-parallel.sh scripts/mutation-test.sh; then
