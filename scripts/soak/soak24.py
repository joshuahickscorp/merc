...
(scripts/validate-readiness.py::qualifying_24h_soak_proven) requires a
...
HARNESS = "scripts/soak/soak24.py"
HARNESS_PATH = ROOT / "scripts" / "soak" / "soak24.py"
HOST = "mercmerc.net"
...
def derive_receipt(
    ...
    *,
    ...
    receipt: dict[str, Any] = {
        ...
        "commands": {
            "status": "python3 scripts/soak/soak24.py status",
            "stamp": "python3 scripts/soak/soak24.py stamp",
            "resume": "python3 scripts/soak/soak24.py resume",
            "finish": "python3 scripts/soak/soak24.py finish",
        },
        "samples": {
            "path": SAMPLES_REL,
        },
...
def usage() -> None:
    print(
        "usage: python3 scripts/soak/soak24.py "
