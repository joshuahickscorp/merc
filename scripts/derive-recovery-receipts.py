...
SOAK_MECHANISMS = [
    ...
    },
    {
        ...
        "exercise": "scripts/test-backup-age-metric.sh writes a stale unix timestamp; no 26h wait",
        "requires_wall_clock": False,
    },
    {
...
def soak_derivation(completed_at: str, suite_pass: bool) -> dict[str, Any]:
    ...
    return {
        ...
        "conclusion_text": (
            "Every named time-dependent mechanism in control/ has a period that is "
...
def main() -> int:
    ...
    for mode in REQUIRED_MODES:
        ...
        write_bound(
            ...
            receipt,
            "scripts/derive-recovery-receipts.py",
    ...
    write_bound(
        ...
        soak,
        "scripts/derive-recovery-receipts.py",
        "soak requirement derivation from named control/ periods",
    )
