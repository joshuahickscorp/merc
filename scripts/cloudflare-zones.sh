...
#
#   bash scripts/cloudflare-zones.sh list
#   bash scripts/cloudflare-zones.sh show   <zone>
#   bash scripts/cloudflare-zones.sh backup <zone>
#   bash scripts/cloudflare-zones.sh delete <zone>
