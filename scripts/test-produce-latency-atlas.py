...
never a borrowed percentile.
    ...
    python3 scripts/test-produce-latency-atlas.py
"""
...
PRODUCER_PATH = ROOT / "scripts" / "produce-latency-atlas.py"
...
def test_unmeasured_atlas_binds_to_candidate() -> None:
    ...
    check(doc.get("produced_by") == "scripts/produce-latency-atlas.py", f"produced_by={doc.get('produced_by')!r}")
