...
Stamps source_commit via scripts/lib/receipt_binding.py as the last step.
"""
...
PRODUCER = "scripts/produce-payment-simulator.py"
    ...
    try:
        ...
        writer = subprocess.run(
            [
                ...
                str(OUT),
                "--harness",
                "control/stripe_simulator.go (release stripe-simulate)",
                "--payload-file",
                str(payload_path),
                "--build-binary",
                str(SIMULATOR),
