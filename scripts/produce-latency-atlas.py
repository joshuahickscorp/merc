...
Bind uses the existing helpers: scripts/lib/receipt_binding.py (candidate,
stamp) and scripts/lib/evidence_binding.py (producer identity, bound write).
...
freshly measured at that same commit.
    ...
    python3 scripts/produce-latency-atlas.py
    python3 scripts/produce-latency-atlas.py --out /tmp/latency-atlas.json
    python3 scripts/produce-latency-atlas.py --measurements cells.json --out /tmp/atlas.json
"""
...
PRODUCER = "scripts/produce-latency-atlas.py"
...
STAGE_CATALOG: tuple[dict[str, str | None], ...] = (
    {
        ...
        "harness": None,
        "unmeasured_reason": (
            "no latency harness: control/topology_planner_test.go and "
            "control/plan_calibration.go are correctness tests, not a "
    ...
    },
    {
        ...
        "harness": None,
        "unmeasured_reason": (
            "no e2e lease latency harness: control/service_lease_*_test.go are "
    ...
    },
    {
        ...
        "harness": None,
        "unmeasured_reason": (
            "no latency harness: control/artifact_harness_test.go is a "
    ...
    },
    {
        ...
        "unmeasured_reason": (
            "harness exists (scripts/bench-harness.py, merc-agent bench-batch) "
    ...
    },
    {
        ...
        "harness": "control/merc_latency_gap_accounting_test.go",
        "unmeasured_reason": (
