...
Does not edit control/pricing.go.
"""
...
_bh_path = ROOT / "scripts" / "bench-harness.py"
...
def main() -> int:
    ...
    payload = {
        ...
        "measurement": {
            ...
            "error_notes": [
                ...
                "control/pricing.go ASSUMED apple_silicon_ultra 65 W is not edited and is package-boundary, not this receipt.",
            ],
        },
        "model": {
            "path": model_path,
        ...
        "not_production_pricing_truth": (
            ...
            "written into control/pricing.go without a separate pricing lane."
        ),
        "vs_assumed_sustained_watts": {
            "hw_class": "apple_silicon_ultra",
            "assumed_watts": 65.0,
            "assumed_kind": "ASSUMED",
            "assumed_source": "control/pricing.go sustainedWattsByHWClass (not edited)",
            "comparison_caveat": (
    ...
    harness = "scripts/energy-deltas-measure.py"
