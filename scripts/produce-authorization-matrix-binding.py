...
actually registered in control/api.go — and that agreement is only true of a
particular commit. scripts/validate-authorization-matrix.py proves it; this
...
PRODUCER = "scripts/produce-authorization-matrix-binding.py"
...
def main() -> int:
    ...
    doc["validated_by"] = "scripts/validate-authorization-matrix.py"
