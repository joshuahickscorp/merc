...
evidence path. Nothing in scripts/ or the Makefile previously captured that
...
AGENT_MAIN = ROOT / "agent" / "src" / "main.rs"
...
def main() -> int:
    if not AGENT_MAIN.is_file():
        print(
            "produce-hardware-characterization: agent/src/main.rs is not on disk; "
