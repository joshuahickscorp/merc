...
def main() -> int:
    ...
    if len(mutations) != 104 or [item["id"] for item in mutations] != list(range(1, 105)):
        raise SystemExit("manifest does not contain exactly the 104 declared mutations")
    ...
    print("test-mutation-manifest: PASS 104 exact mutations and timing guards")
    return 0
