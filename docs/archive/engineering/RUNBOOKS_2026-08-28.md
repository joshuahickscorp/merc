...
unchanged. See `docs/archive/engineering/RENAME_REGISTER.md` before renaming any of them.
...
per `docs/archive/engineering/RENAME_REGISTER.md`: rename the registry package first, then the
