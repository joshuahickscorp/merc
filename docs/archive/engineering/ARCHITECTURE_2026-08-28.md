...
`docs/archive/engineering/PROGRAMME.md § "Merc shippability status"` (per-lane rung) and `RELEASE_READINESS.md` with
...
rung lives in `docs/archive/engineering/PROGRAMME.md § "Merc shippability status"` alongside every other lane.
...
magnitude better per supplier-hour. See `docs/archive/engineering/PROGRAMME.md § "Which lane can actually pay a supplier"`. That is a
